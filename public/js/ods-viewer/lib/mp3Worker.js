...
self.onmessage = function(e) {
	...
	case 'init':
		...
		saveTime = e.data.config.timestamp;
		checkInterval = e.data.config.checkInterval;
	...
	case 'encode':
		...
		self.postMessage({cmd: 'data', buf: mp3data.data, saveTime:saveTime, checkInterval:checkInterval});
		break;
	case 'finish':
